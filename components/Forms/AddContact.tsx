...
const AddContact = () => {
  ...
  const onCreateContact = async (formData: FormData) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-row items-center w-full space-x-2">
        <button
          type="submit"
          className={`flex items-center justify-center w-full p-3 rounded-lg bg-blue-500 hover:bg-opacity-60 ${isSubmitting ? 'cursor-wait' : 'cursor-pointer'}`}
